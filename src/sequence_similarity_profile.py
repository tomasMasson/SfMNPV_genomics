...
def sequence_similarity(seq1, seq2):
    '''
    Calculates the pairwise sequence identity between two
    sequences.
    '''
...
def get_similarity_profile(seq1, seq2, step: int, window: int):
    '''
    Computes the sequence similarity score for two sequences
    using a sliding window approach with a custom step and window. 
    To calculate similarity, this function uses
...
def plot_similarity(profiles):
    '''
    Plot sequences pair-wise similarities.
    '''
