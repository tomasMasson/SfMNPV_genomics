...
def filter_snv_sites(filename):
    '''
    Takes a VCF file created by snp-sites and return a dictionary ready
    to be inyected into pandas.
...
def plot_snv_distribution(data):
    '''
    Creates a categorical plot displaying the distribution of SNV for
    each isolate.
    '''
