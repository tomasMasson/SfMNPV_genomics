...
def get_alternative_alleles(vcf_file):
    '''
    Takes a .vcf file and returns a dictionary showing the sites were
    alternative allele frequency is greater than reference allele.
...
def mutate_sequence(sequence, mutations):
    ...
    to select positions in a reference sequence and introduce specific
    point mutation.
    '''
...
def argument_parser():
    ...
    parser.add_argument('sequence',
                        help='Sequence file to be mutated, in .fa format')
