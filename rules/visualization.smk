...
rule plot_snv_frequency:
    input:
        "variants_calling/sfmnpv_snv_ann.vcf"
    output:
        "variants_calling/snv_classification.svg",
        "variants_calling/snv_distribution.svg"
    shell:
        """
        python src/plot_intrahost_variants.py {input} && \
        mv snv_classification.svg {output[0]} && \
        mv snv_distribution.svg {output[1]}
        """
